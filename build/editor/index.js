...
function NameFieldsPanel() {
  const [meta, setMeta] = (0,_wordpress_core_data__WEBPACK_IMPORTED_MODULE_6__.useEntityProp)('postType', 'people', 'meta');
  const [, setTitle] = (0,_wordpress_core_data__WEBPACK_IMPORTED_MODULE_6__.useEntityProp)('postType', 'people', 'title');
  const [, setSlug] = (0,_wordpress_core_data__WEBPACK_IMPORTED_MODULE_6__.useEntityProp)('postType', 'people', 'slug');
  const {
    lockPostSaving,
    unlockPostSaving,
    editPost
